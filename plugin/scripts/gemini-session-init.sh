...
# Skipped when CODERLM_SUBCALL=1 (subprocess agents should not
...
# Generate a unique instance ID for this Gemini CLI session.
# $PPID is the Gemini CLI process — all run_shell_command from this session
